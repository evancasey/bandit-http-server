...
```
$ curl -i -H "Content-Type: application/json" -X PUT -d '{"name":"test","algo_type":"egreedy","horizon_type":"time", "horizon_value":60, "epsilon":0.2}' http://localhost:5000/api/v1.0/bandits/1
```
